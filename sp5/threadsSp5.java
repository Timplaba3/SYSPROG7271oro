...
class PingCheckerClass implements Runnable {
    ...
    public PingCheckerClass(int[] array, int start, int end, String ip, boolean debug) {
        this.array = array;
        this.start = start;
        this.end = end;
        this.ip = ip;
...
public class threadsSp5 {
    ...
    public static void main(String[] args)
    {
        ...
        Thread thread1 = new Thread(new PingCheckerClass(pingRes, 0, 64, ip_str, debug));
        Thread thread2 = new Thread(new PingCheckerClass(pingRes, 65, 129, ip_str, debug));
        Thread thread3 = new Thread(new PingCheckerClass(pingRes, 130, 194, ip_str, debug));
        Thread thread4 = new Thread(new PingCheckerClass(pingRes, 195, 255, ip_str, debug));
